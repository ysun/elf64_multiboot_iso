...
extern elf_section_t *add_text_section(elf_file_t *elf_file, elf_section_t *symbol_table_section, elf_section_t *symbol_table_strings_section, Elf64_Addr vaddr);
